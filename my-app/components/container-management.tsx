...
import { Calendar, Upload, Container, Users, Package, FileText, Home, ChevronRight } from "lucide-react"
        ...
        <aside className="w-64 border-r bg-sidebar min-h-[calc(100vh-4rem)] p-4">
          <nav className="space-y-2">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
              ...
              <ChevronRight className="h-4 w-4" />
              <span className="text-foreground">Añadir Contenedor</span>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-1">
                  ...
                  <Button
                    variant="secondary"
                    className="w-full justify-between text-left bg-sidebar-accent text-sidebar-accent-foreground"
                  >
                    <div className="flex items-center gap-3">
